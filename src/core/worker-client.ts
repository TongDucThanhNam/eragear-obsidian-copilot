...
import contextWorkerBlob from "../workers/graph.worker";
...
export class WorkerClient {
	...
	): Promise<{ order: number; size: number }> {
		return this.sendMessage("BUILD_GRAPH", payload);
	}

	public async computePageRank(
		payload: ComputePageRankPayload,
	): Promise<PageRankResult> {
		return this.sendMessage("COMPUTE_PAGERANK", payload);
	}

	public async spreadingActivation(
		payload: SpreadingActivationPayload,
	): Promise<SpreadingActivationResult> {
		return this.sendMessage("SPREADING_ACTIVATION", payload);
	}
	...
	public async analyzeResolvedGraph(
		...
		return this.sendMessage<GraphAnalysisResult>(
