...
import type { SessionSummary } from "../models/session-persistence";
import type {
	PromptResponse,
	SessionModelState,
	SessionUpdate,
...
export interface IAgentClient {
	...
	saveCurrentSession(title: string, updates: SessionUpdate[]): Promise<string>;
	...
	/** Get ID of currently connected agent */
